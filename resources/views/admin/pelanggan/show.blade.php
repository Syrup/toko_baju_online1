        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="d-flex align-items-center gap-3">
                    <a href="{{ route('admin.pelanggan.index') }}" style="text-decoration: none; color: #667eea;">
                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-body p-4">
                        ...
                        <div class="mb-4 pb-4" style="border-bottom: 1px solid #eee;">
                            <div class="d-flex align-items-center gap-3">
                                <div
                                    style="width: 80px; height: 80px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 50%; display: flex; align-items: center; justify-content: center;">
                                    <i class="fas fa-user" style="font-size: 2.5rem; color: white;"></i>
                                </div>
                                <div>
                                    <h2 style="color: #333; font-weight: 600; margin: 0;">{{ $pelanggan->name }}
                                    </h2>
                        ...
                        <div class="row" style="border-top: 1px solid #eee; padding-top: 1.5rem;">
                            <div class="col-12 col-md-6 mb-3">
                                <label style="font-weight: 600; color: #999; font-size: 0.85rem;">Bergabung pada:</label>
            ...
            <div class="modal-content border-0">
                ...
                <div class="modal-body p-4">
                    <p style="color: #666; margin: 0;">
                        Apakah Anda yakin ingin menghapus pelanggan <strong>{{ $pelanggan->name }}</strong>?
                    </p>
