            ...
            <div class="card border-0 shadow-sm" style="border-radius: 12px;">
                <div class="card-body p-4">
                    <form action="{{ route('profil.update') }}" method="POST">
                        ...
                        <!-- Nama Lengkap -->
                        <div class="mb-4">
                            <label for="name" style="font-weight: 600; color: #333; margin-bottom: 0.5rem; display: block;">
                        ...
                        <!-- Role Info (Read Only) -->
                        <div class="mb-4">
                            <label for="role" style="font-weight: 600; color: #333; margin-bottom: 0.5rem; display: block;">
                            ...
                            <small style="color: #999; font-size: 0.85rem; margin-top: 0.5rem; display: block;">Role tidak dapat diubah melalui form ini</small>
                        </div>
