...
<div style="max-width: 1200px; margin: 0 auto; padding: 2rem 1rem;">
    ...
    <nav aria-label="breadcrumb" class="mb-4">
        <ol class="breadcrumb" style="background-color: transparent; padding: 0;">
            <li class="breadcrumb-item"><a href="{{ route('produk.index') }}" style="color: #667eea; text-decoration: none;">Produk</a></li>
    ...
    <div class="row g-4">
        ...
        <div class="col-md-6">
            <div class="card border-0 shadow-sm" style="border-radius: 12px; overflow: hidden;">
                <div style="height: 500px; background: linear-gradient(135deg, #f0f0f0 0%, #e9ecef 100%); overflow: hidden; display: flex; align-items: center; justify-content: center;">
                    @if($tproduk->foto)
                        <img src="{{ asset('storage/'.$tproduk->foto) }}"
                             alt="{{ $tproduk->nama_produk }}"
                ...
                <div class="card-body p-4 d-flex flex-column">
                    ...
                    <div class="mb-4">
                        <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 1.5rem; border-radius: 10px; color: white;">
                            ...
                            <p style="font-size: 0.8rem; margin: 0.5rem 0 0 0; opacity: 0.85;">Harga sudah termasuk pajak</p>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mb-3">
                            ...
                            <div style="display: flex; gap: 0.5rem; align-items: center;">
                                <button class="btn btn-outline-secondary" onclick="decreaseQty()" style="width: 45px; padding: 0;">−</button>
                                <input type="number" id="jumlahBeli" class="form-control" 
                                       value="1" min="1" max="100"
                                       onchange="hitungTotal()" 
                                       onkeyup="hitungTotal()"
                                       style="text-align: center; width: 70px; border: 1px solid #ddd;">
                                <button class="btn btn-outline-secondary" onclick="increaseQty()" style="width: 45px; padding: 0;">+</button>
                            </div>
                        </div>
                    ...
                    <!-- Total Harga Summary -->
                    <div class="mb-4 p-3 rounded" style="background: linear-gradient(135deg, #f8f9fa 0%, #f0f0f0 100%); border-left: 4px solid #667eea;">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.5rem;">
                            <span style="color: #666;">Subtotal:</span>
                            <span style="font-weight: 600; color: #333;">Rp <span id="subtotal">{{ number_format($tproduk->harga, 0, ',', '.') }}</span></span>
                        </div>
                        <hr style="margin: 0.5rem 0;">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            <span style="font-weight: 700; color: #333; font-size: 1.1rem;">Total:</span>
                            <span style="font-weight: 700; color: #667eea; font-size: 1.3rem;">Rp <span id="totalHarga">{{ number_format($tproduk->harga, 0, ',', '.') }}</span></span>
                        </div>
                    </div>
            ...
            <div class="card border-0 shadow-sm" style="border-radius: 12px;">
                ...
                <div class="card-body p-4">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <p style="color: #666; margin: 0;">
                                <strong style="color: #333;">Ditambahkan:</strong> {{ $tproduk->created_at ? $tproduk->created_at->format('d M Y') : '-' }}
                            </p>
                        </div>
                    </div>
                </div>
