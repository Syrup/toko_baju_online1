...
<div style="max-width: 900px; margin: 0 auto;">
    ...
    @if($message = Session::get('success'))
        <div class="row mb-4">
            <div class="col-12">
                <div class="alert alert-success d-flex align-items-center" style="background: linear-gradient(135deg, rgba(16, 185, 129, 0.1) 0%, rgba(5, 150, 105, 0.1) 100%); border: 1px solid rgba(16, 185, 129, 0.3); border-radius: 8px;">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="mb-4 pb-4" style="border-bottom: 1px solid #eee;">
                        <div class="d-flex align-items-center gap-4">
                            <div style="width: 100px; height: 100px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 50%; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
                            ...
                            <div style="flex-grow: 1;">
                                ...
                                <p style="color: #999; font-size: 0.85rem; margin: 0;">
                                    <i class="fas fa-tag me-1"></i>Role: <strong style="color: #333;">{{ ucfirst($user->role) }}</strong>
                                </p>
                            </div>
                            <div>
                    ...
                    <div class="mb-4">
                        <div style="background-color: #f8f9fa; padding: 1.5rem; border-radius: 8px;">
                            ...
                            <div style="display: flex; align-items: center; gap: 1rem;">
                                <span class="badge" style="background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: white; padding: 0.5rem 1rem; border-radius: 20px; font-weight: 600;">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card border-0 shadow-sm" style="border-radius: 12px;">
                <div class="card-body p-4">
                    <h5 style="color: #333; font-weight: 600; margin-bottom: 2rem; padding-bottom: 1rem; border-bottom: 1px solid #eee;">
                    ...
                    <div class="row mb-4">
                        <div class="col-12">
                            <div class="d-flex align-items-center justify-content-between p-3" style="background-color: #f8f9fa; border-radius: 8px;">
                                <div>
                                    <p style="color: #333; font-weight: 600; margin: 0;">Password</p>
                                    <p style="color: #999; font-size: 0.9rem; margin: 0.5rem 0 0 0;">Ubah password akun Anda secara berkala untuk keamanan</p>
                                </div>
                        ...
                        <div class="col-12">
                            <div class="d-flex align-items-center justify-content-between p-3" style="background-color: #f8f9fa; border-radius: 8px;">
                                <div>
                                    ...
                                    <p style="color: #999; font-size: 0.9rem; margin: 0.5rem 0 0 0;">Tingkatkan keamanan akun dengan verifikasi dua faktor</p>
                                </div>
                                <span class="badge" style="background: #e5e7eb; color: #666; padding: 0.5rem 1rem; border-radius: 20px; font-weight: 600;">
            ...
            <div class="card border-0 shadow-sm" style="border-radius: 12px;">
                <div class="card-body p-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6 mb-3">
                            <label style="font-weight: 600; color: #999; font-size: 0.85rem;">Terakhir Diperbarui:</label>
                            <p style="color: #333; margin: 0.5rem 0 0 0;">
