                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="mb-3">
                            ...
                            <input type="number" id="jumlahBeli" class="form-control" value="1" min="1">
                        </div>
                    </div>
                </div>
                <div class="mb-3">
                    <label for="keterangan" style="font-weight: 600; color: #333;">Keterangan (Opsional)</label>
                    <textarea id="keterangan" class="form-control" rows="3" placeholder="Masukkan keterangan pesanan Anda..."></textarea>
                </div>
