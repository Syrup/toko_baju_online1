                        ...
                        <form action="{{ route('admin.pelanggan.store') }}" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control form-control-lg @error('name') is-invalid @enderror"
                                    id="name" name="name" placeholder="Masukkan nama pelanggan" value="{{ old('name') }}"
                            ...
                            <div class="mb-4">
                                ...
                                <input type="email"
                                    ...
                                    name="email" placeholder="Masukkan email pelanggan" value="{{ old('email') }}" required
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-6">
                                    <label for="password_confirmation"
                                        style="font-weight: 600; color: #333; margin-bottom: 0.5rem; display: block;">
                                        <i class="fas fa-lock me-2" style="color: #667eea;"></i>Konfirmasi Password
                                        <span style="color: #ef4444;">*</span>
                                    </label>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('nomor_telepon') }}" style="border-color: #ddd; border-radius: 8px;">
                                @error('nomor_telepon')
                                    <div class="invalid-feedback d-block" style="color: #ef4444;">{{ $message }}</div>
                                @enderror
                            </div>
