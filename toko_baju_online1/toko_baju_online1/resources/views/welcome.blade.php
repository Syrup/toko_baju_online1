...
<body>
        ...
        <div class="container-lg">
            <div class="row align-items-center">
                <div class="col-lg-6 hero-content">
                    ...
                    <p class="hero-subtitle">Temukan gaya fashion terbaru dengan harga terjangkau. Kualitas premium, desain eksklusif, dan kenyamanan maksimal.</p>
                    <div>
                        <a href="{{ route('produk.index') }}" class="btn-primary-custom">
    ...
    <section class="products-preview" id="produk">
        <div class="container-lg">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="product-card">
                        ...
                        <div class="product-body">
                            ...
                            <a href="{{ route('produk.index') }}" class="btn-primary-custom" style="width: 100%; text-align: center;">Lihat Detail</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
            ...
            <div class="text-center mt-4">
                <a href="{{ route('produk.index') }}" class="btn-primary-custom" style="font-size: 1.1rem;">
    ...
    <section class="cta-section">
        <div class="container-lg">
            ...
            <p class="cta-text">Jangan lewatkan kesempatan untuk mendapatkan koleksi baju terbaik dengan harga spesial</p>
            <a href="{{ route('produk.index') }}" class="btn-primary-custom" style="background: white; color: #2563eb;">
        ...
        <div class="container-lg">
            <div class="row mb-4">
                <div class="col-lg-3 col-md-6 mb-3">
                    <h6>Tentang Kami</h6>
                    <p>ORIKAWE STORE adalah toko online terpercaya yang menyediakan koleksi baju berkualitas dengan harga terjangkau.</p>
                </div>
                <div class="col-lg-3 col-md-6 mb-3">
                    <h6>Navigasi</h6>
                    <ul class="list-unstyled">
                        ...
                        <li><a href="{{ route('produk.index') }}">Belanja Sekarang</a></li>
                    </ul>
                </div>
                <div class="col-lg-3 col-md-6 mb-3">
                    <h6>Dukungan</h6>
            ...
            <div class="footer-divider">
                <div class="text-center">
                    <p>&copy; 2026 ORIKAWE STORE. Semua hak dilindungi. Dibuat dengan <i class="fas fa-heart" style="color: #2563eb;"></i> untuk Anda.</p>
                </div>
            </div>
        </div>
    </footer>
