...
<div style="max-width: 800px; margin: 0 auto;">
    ...
    <div class="row mb-4">
        <div class="col-12">
            <h1 class="mb-1" style="color: #333; font-weight: 700; font-size: 2rem;">Tambah Pelanggan Baru</h1>
            <p class="text-muted" style="margin: 0;">Isi form di bawah untuk menambah pelanggan baru</p>
        </div>
    </div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-4">
                    <form action="{{ route('pelanggan.store') }}" method="POST">
                        ...
                        <!-- Nama Pelanggan -->
                        <div class="mb-4">
                            <label for="nama_konsumen" style="font-weight: 600; color: #333; margin-bottom: 0.5rem; display: block;">
                        ...
                        <!-- Email -->
                        <div class="mb-4">
                            <label for="email" style="font-weight: 600; color: #333; margin-bottom: 0.5rem; display: block;">
                        ...
                        <!-- Nomor Telepon -->
                        <div class="mb-4">
                            <label for="nomor_telepon" style="font-weight: 600; color: #333; margin-bottom: 0.5rem; display: block;">
                        ...
                        <!-- Alamat -->
                        <div class="mb-4">
                            <label for="alamat" style="font-weight: 600; color: #333; margin-bottom: 0.5rem; display: block;">
                            ...
                            <textarea class="form-control @error('alamat') is-invalid @enderror" 
                                      ...
                                      style="border-color: #ddd; border-radius: 8px;">{{ old('alamat') }}</textarea>
                            @error('alamat')
                                <div class="invalid-feedback d-block" style="color: #ef4444;">{{ $message }}</div>
                            @enderror
                        </div>
