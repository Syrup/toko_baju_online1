                        ...
                        <table class="table table-hover mb-0" style="background-color: white;">
                            <thead>
                                <tr style="background: linear-gradient(135deg, #f8f9fa 0%, #f0f1f3 100%); border-bottom: 2px solid #ddd;">
                                    ...
                                    <th style="color: #333; font-weight: 600; padding: 1.2rem; border: none;">Nama Pelanggan</th>
                                    <th style="color: #333; font-weight: 600; padding: 1.2rem; border: none;">Email</th>
                                    <th style="color: #333; font-weight: 600; padding: 1.2rem; border: none;">Nomor Telepon</th>
                                    <th style="color: #333; font-weight: 600; padding: 1.2rem; border: none;">Alamat</th>
                            ...
                            <tbody>
                                @foreach ($pelanggan as $index => $p)
                                    <tr style="border-bottom: 1px solid #eee; transition: all 0.3s ease;"
                                        ...
                                        <td style="color: #666; padding: 1.2rem; border: none;">
                                            <a href="tel:{{ $p->nomor_telepon }}" style="color: #667eea; text-decoration: none;">
                                                {{ $p->nomor_telepon }}
                                            </a>
                                        </td>
                                        <td style="color: #666; padding: 1.2rem; border: none;">
...
<script>
    ...
    document.getElementById('formHapus').addEventListener('submit', function(e) {
        if (idPelangganHapus) {
            this.action = `/pelanggan/${idPelangganHapus}`;
        }
    });
</script>
@endsection
