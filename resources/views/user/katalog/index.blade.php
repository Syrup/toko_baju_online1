...
<div style="max-width: 1200px; margin: 0 auto;">
    ...
    <div class="row mb-4 align-items-center">
        <div class="col-12">
            <h1 class="mb-1" style="color: #333; font-weight: 700; font-size: 2rem;">Katalog Produk</h1>
            <p class="text-muted" style="margin: 0;">Temukan koleksi baju terbaik kami</p>
        </div>
    </div>
    ...
    <div class="row mb-4">
        <div class="col-12">
            <form method="GET" action="{{ route('user.katalog.index') }}" class="d-flex gap-2">
                <div class="flex-grow-1">
                    <input type="text" name="search" class="form-control form-control-lg" 
                           placeholder="Cari produk berdasarkan nama atau deskripsi..." 
                           value="{{ $search ?? '' }}"
                           style="border-color: #ddd; border-radius: 8px; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.05);">
                </div>
        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="alert alert-info d-flex align-items-center" style="background: linear-gradient(135deg, rgba(102, 126, 234, 0.1) 0%, rgba(118, 75, 162, 0.1) 100%); border: 1px solid rgba(102, 126, 234, 0.3); border-radius: 8px;">
                    ...
                    <span>Hasil pencarian untuk <strong>"{{ $search }}"</strong> 
                ...
                <div class="col-12 col-sm-6 col-lg-4 col-xl-3">
                    <div class="card border-0 shadow-sm h-100 product-card">
                        ...
                        <div class="card-body d-flex flex-column" style="padding: 1.2rem;">
                            ...
                            <!-- Price -->
                            <div class="mb-3">
                                <p class="mb-0" style="font-size: 1.1rem; color: #667eea; font-weight: 700;">
                            ...
                            <div class="d-flex justify-content-between align-items-center" style="gap: .5rem;">
                                <a href="{{ route('user.katalog.show', $p->id) }}" 
        ...
        <div class="modal-content">
            <form action="{{ route('user.pesanan.create') }}" method="GET">
                <div class="modal-header border-bottom-0 pb-0">
                    <h5 class="modal-title" id="modalPesananLabel" style="font-weight: 700; color: #333;">
                        <i class="fas fa-shopping-cart me-2" style="color: #667eea;"></i>Konfirmasi Pesanan
                    </h5>
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="mb-3">
                        <label style="font-weight: 600; color: #333;">Produk</label>
                        <p id="modalProdukNama" style="color: #666; margin: 0;"></p>
                    </div>
                    <div class="row">
                        <div class="col-6">
                            <div class="mb-3">
                                <label style="font-weight: 600; color: #333;">Harga</label>
                                <p id="modalProdukHarga" style="color: #667eea; font-weight: 600; margin: 0;"></p>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="mb-3">
                                <label for="jumlahBeli" style="font-weight: 600; color: #333;">Jumlah</label>
                                <input type="number" id="jumlahBeli" name="jumlah" class="form-control" value="1" min="1">
                            </div>
                        </div>
                    </div>
                    <div class="mb-3">
                        <label for="keterangan" style="font-weight: 600; color: #333;">Keterangan (Opsional)</label>
                        <textarea id="keterangan" name="keterangan" class="form-control" rows="3" placeholder="Masukkan keterangan pesanan Anda..."></textarea>
                    </div>
...
<script>
    let produkPesanan = { id: null, nama: null, harga: null };
