    ...
    <div style="max-width: 800px; margin: 0 auto; padding: 2rem 1rem;">
        ...
        <div class="mb-4">
            <h1 class="mb-1" style="color: #333; font-weight: 700; font-size: 2rem;">
                <i class="fas fa-plus-circle me-2" style="color: #3b82f6;"></i>Tambah Produk Baru
            </h1>
            <p class="text-muted" style="margin: 0;">Tambahkan produk baru ke koleksi toko kami</p>
        </div>
                ...
                <form action="{{ route('admin.produk.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control @error('nama_produk') is-invalid @enderror" id="nama_produk"
                            name="nama_produk" placeholder="Masukkan nama produk (contoh: Kaos Premium Katun)"
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control @error('deskripsi') is-invalid @enderror" id="deskripsi"
                            ...
                            placeholder="Tuliskan deskripsi lengkap tentang produk, bahan, ukuran, dan keunggulan produk..."
                            value="{{ old('deskripsi') }}" required
                            style="padding: 0.75rem 1rem; border: 1px solid #e0e0e0; border-radius: 8px; transition: all 0.3s ease;"></textarea>
                        @error('deskripsi')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" class="form-control @error('harga') is-invalid @enderror" id="harga"
                            name="harga" placeholder="Contoh: 150000" value="{{ old('harga') }}" step="0.01" min="0"
                            required
                            style="padding: 0.75rem 1rem; border: 1px solid #e0e0e0; border-radius: 8px; transition: all 0.3s ease;">
                        @error('harga')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                    ...
                    <div class="mb-4">
                        ...
                        <small class="text-muted d-block mt-2">
                            <i class="fas fa-info-circle me-1"></i>Format: JPG, PNG, GIF. Ukuran maksimal: 2MB
                        </small>
                        @error('foto')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
