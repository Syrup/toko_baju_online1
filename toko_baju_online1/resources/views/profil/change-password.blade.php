...
<div style="max-width: 800px; margin: 0 auto;">
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex align-items-center gap-3">
                <a href="{{ route('profil.index') }}" style="text-decoration: none; color: #667eea;">
    ...
    @if($errors->any())
        <div class="row mb-4">
            <div class="col-12">
                <div class="alert alert-danger d-flex align-items-center" style="background: linear-gradient(135deg, rgba(239, 68, 68, 0.1) 0%, rgba(220, 38, 38, 0.1) 100%); border: 1px solid rgba(239, 68, 68, 0.3); border-radius: 8px;">
            ...
            <div class="card border-0 shadow-sm" style="border-radius: 12px;">
                <div class="card-body p-4">
                    <form action="{{ route('profil.update-password') }}" method="POST">
                        ...
                        <!-- Password Saat Ini -->
                        <div class="mb-4">
                            <label for="current_password" style="font-weight: 600; color: #333; margin-bottom: 0.5rem; display: block;">
                            ...
                            <div style="position: relative;">
                                ...
                                <i class="fas fa-eye" style="position: absolute; right: 1rem; top: 50%; transform: translateY(-50%); color: #999; cursor: pointer;" 
                        ...
                        <!-- Password Baru -->
                        <div class="mb-4">
                            <label for="password" style="font-weight: 600; color: #333; margin-bottom: 0.5rem; display: block;">
                            ...
                            @error('password')
                                <div class="invalid-feedback d-block" style="color: #ef4444;">{{ $message }}</div>
                            @enderror
                            <small style="color: #999; font-size: 0.85rem; margin-top: 0.5rem; display: block;">Password minimal 8 karakter</small>
                        </div>

                        <!-- Konfirmasi Password Baru -->
                        <div class="mb-4">
                            <label for="password_confirmation" style="font-weight: 600; color: #333; margin-bottom: 0.5rem; display: block;">
